...
function applyPageCopyPolish({ slug, title, description, body }) {
  ...
  if (slug === "about-the-film") {
    return {
      ...
      body: body
        .replace(
          ", the boom years that followed, and September 11.",
          " and September 11.",
        )
        .replace(
          "returned to the job.",
        ...
        .replace(
          "Caleb shot the first version as a nine-minute college project. He expanded that cut into Golden Wings.",
          "Caleb first made the story as a nine-minute college project, then expanded it into Golden Wings.",
        )
        .replace(
          "appears on camera to describe what Jay did.",
          "appears on camera to describe Jay's work.",
        ),
    };
  }
